<section id="contact" class="text-light">
  ...
  <!-- Footer Content -->
    <div class="bg-footer">
        ...
        <div class="row">
            <h3 class="fw-bold col-4">Окажете влияние.</br>
            Промяната започва от вас!</h3>
            <h5 class="fw-bold col-8">„Разработихме уникалния си пазар с финансиране от Министерството на енергетиката на България, за да направим чистата енергия за дома достъпна за всички.“</h5>
        </div>
        <!-- Social Links -->
        <ul class="list-unstyled d-flex flex-column flex-md-row justify-content-center align-items-center fw-bold my-5">
            ...
            <a href="https://www.instagram.com/studentcouncil_ppmg" target="_blank" class="text-light instagram fs-4">
                <i class="bi bi-instagram me-2"></i>@SGS_Connect
            </a>
            </li>
            <li class="me-md-3 mb-2">
            <a href="https://www.facebook.com/ppmg.botevgrad" target="_blank" class="text-light facebook fs-4">
                <i class="bi bi-facebook me-2"></i>SGS Connect
            </a>
            </li>
            <li class="mb-2">
            <a href="https://www.youtube.com/@user-eo5lw6cz2k" target="_blank" class="text-light youtube fs-4">
        ...
        <div class="text-center">
            ...
            Този проект е изцяло измислен и е създаден само с учебна цел. Всички използвани имена, лога и търговски марки са измислени или използвани единствено с демонстрационна цел. Проектът няма връзка с реална компания и не представлява действителна търговска дейност.
            </p>
        </div>
        </div>
    </div>
